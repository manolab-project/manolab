/****************************************************************************
** Meta object code from reading C++ file 'main-cli.h'
**
...
#error "The header file 'main-cli.h' doesn't include <QObject>."
...
void Task::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Task::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Task::ended)) {
                *result = 0;
                return;
            }
        }
